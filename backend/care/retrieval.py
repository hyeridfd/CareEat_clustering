...
DX_QUERY = [
    (("당뇨", "diabet"), "당뇨 의학영양요법 식이섬유 가당음료 단백질 제한 혈당"),
    (("고혈압", "혈압"), "고혈압 소금 섭취 제한 저염 조리 칼륨 채소 과일 DASH"),
...
NUT_QUERY = {
    ...
    "fe": "노인 철분 섭취 부족",
    "k": "노인 칼륨 섭취",
    "na": "삼삼한 조리 전략 국물 줄이기 천연조미료 향신채 염도 저감",
}

TEXTURE_QUERY = "먹기 쉬운 조리 전략 부드럽게 연육 다진 식재료 촉촉하게 다진식 갈은식"
...
RULE_QUERY = [
    (("R_MALNUT", "R_LOW_BMI", "R_WEIGHT", "R_UNDER"),
     "노인 저체중 영양불량 영양 강화 조리 에너지 단백질 보충 간식 추가"),
    (("R_DEPEND", "R_ASSIST"),
    ...
    (("R_ORAL", "R_DENT"),
     "노인 구강 관리 의치 치아 식사"),
    (("R_ACT", "R_IPAQ", "R_SARCO", "R_LOW_ACT"),
     "노인 신체 활동 저항운동 복합운동 근육량 유지 단백질 함께 제공"),
    (("R_LOW_BMI", "R_MALNUT", "R_SARCO"),
     "근감소증 예방 단백질 체중 1kg당 1.2g 세 끼 나누어 섭취"),
